...
public class CimsgError {

	private byte light_broken_wire;
	private byte light_fuse;
	private byte power_screen;
	private byte light_close;
	private byte ci_warning;
	private byte track_warning;
	private byte ups_fail;
	private byte leu_status;
	private byte ci_zc_comm;
	private byte ci1_status;
	private byte ci2_status;
	private byte ci1_power;
	private byte ci2_power;
	private byte ci_num;
	private byte ci_ci_comm;
	private byte turnback_auto;
	private byte switch_none;
	private byte signal_check_num;
	private byte signal_check_status;
	private byte psd_num;
	private byte ci_psd_comm;
	private byte ci_mode;
	private byte ci_block;
	private byte power_on_unlock;
	private byte self_discipline_request;
	...
	public byte getSelf_discipline_request() {
		return self_discipline_request;
	}
	public void setSelf_discipline_request(byte self_discipline_request) {
		this.self_discipline_request = self_discipline_request;
	}
