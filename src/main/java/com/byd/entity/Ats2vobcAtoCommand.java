...
public class Ats2vobcAtoCommand {

	private short service_num;
	private short line_num;
	private int next_zc_id;
	private int next_ci_id;
	private int next_ats_id;
	...
	private short direction_plan;
	private short cross_station_id;
	private short next_station_id;
	private short stop_station_time;
	private short cross_station_command;
	private short running_adjust_command;
	private short detain_command;
	private short turnback_command;
	private short turn_command;
	private short door_control;
	private int reserv;
	...
	public short getDirection_plan() {
		return direction_plan;
	}
	public void setDirection_plan(short direction_plan) {
	...
	public short getCross_station_command() {
		return cross_station_command;
	}
	public void setCross_station_command(short cross_station_command) {
	...
	public short getDetain_command() {
		return detain_command;
	}
	public void setDetain_command(short detain_command) {
		this.detain_command = detain_command;
	}
	public short getTurnback_command() {
		return turnback_command;
	}
	public void setTurnback_command(short turnback_command) {
		this.turnback_command = turnback_command;
	}
	public short getTurn_command() {
		return turn_command;
	}
	public void setTurn_command(short turn_command) {
		this.turn_command = turn_command;
	}
	public short getDoor_control() {
		return door_control;
	}
	public void setDoor_control(short door_control) {
